...
typedef struct _MultiPartProcessor{
  ...
  int             m_Remain;
  void*           m_CBContext;
  int             (*cb_HeaderName)(char* theBuffer, int theSize, void* theContext);
  int             (*cb_HeaderValue)(char* theBuffer, int theSize, void* theContext);
  int             (*cb_HeaderParameterName)(char* theBuffer, int theSize, void* theContext);
  int             (*cb_HeaderParameterValue)(char* theBuffer, int theSize, void* theContext);
